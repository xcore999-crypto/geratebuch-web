...
export default function DigitalesGeraetebuchPage() {
  return (
    <>
      <PageHero
        eyebrow="Digitales Gerätebuch"
        title="Ihre Geräte, lückenlos dokumentiert."
        image="/images/page-digitales-geraetebuch.png"
        imageAlt="Fiktives Kosmetikgerät mit digitaler Wartungs- und Dokumentationshistorie"
        description={
            <p>
      ...
      >
            <div className="flex flex-wrap gap-3">
              ...
              <Button href="/kontakt#service-anfragen" variant="outline-light" size="lg">
