...
const variantClasses: Record<Variant, string> = {
  ...
  secondary:
    "bg-white text-navy-900 border border-slate-200 hover:border-brand-300 hover:text-brand-700",
  "outline-light":
...
const base =
  "inline-flex items-center justify-center rounded-btn font-semibold transition-colors duration-150 whitespace-nowrap disabled:opacity-50 disabled:pointer-events-none";
